...
export function SiteFooter() {
  ...
  return <footer className="footer shared-footer"><div className="wrap footer-grid">
    ...
    <div><h3>More from TengYoda</h3>{specialistServices.map(service => <a href={sitePath(`/services/${service.slug}`)} key={service.slug}>{serviceLabel(service)}</a>)}<a href={sitePath("/shipping-routes")}>Country shipping routes</a><a href={sitePath("/services")}>All services</a><a href={sitePath("/blog")}>Logistics blog</a><a href={sitePath("/#network")}>Warehouses & offices</a></div>
