...
export function SiteHeader({ active }: { active?: "about" | "blog" | "services" }) {
  ...
  const serviceLinks = <>{services.map(service => <NavigationMenuLink asChild key={service.slug}><a href={sitePath(`/services/${service.slug}`)} className="mega-service-link"><strong>{serviceLabel(service)}</strong><ArrowRight aria-hidden="true" /></a></NavigationMenuLink>)}<NavigationMenuLink asChild><a href={sitePath("/shipping-from-china-to-australia")} className="mega-service-link"><strong>Shipping China → Australia</strong><ArrowRight aria-hidden="true" /></a></NavigationMenuLink><NavigationMenuLink asChild><a href={sitePath("/shipping-from-china-to-nigeria")} className="mega-service-link"><strong>Shipping China → Nigeria</strong><ArrowRight aria-hidden="true" /></a></NavigationMenuLink><NavigationMenuLink asChild><a href={sitePath("/shipping-from-china-to-oman")} className="mega-service-link"><strong>Shipping China → Oman</strong><ArrowRight aria-hidden="true" /></a></NavigationMenuLink></>;
  return <>
